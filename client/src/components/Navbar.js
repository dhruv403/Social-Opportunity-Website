...
const NavBar = ()=>{
     ...
     const renderList = ()=>{
       if(state){
           return [
            ...
            <li key="0"><Link to="/applications"><div className="tooltip"><i className="fa fa-address-card-o fa-lg" ></i><span className="tooltiptext">Applications</span></div></Link></li>,
            <li key="1"><div className="tooltip"><i  data-target="modal1" className="large material-icons modal-trigger" style={{color:"black"}}>search</i><span className="tooltiptext">User Search</span></div></li>,
    ...
    return(
        <nav>
        <div className="nav-wrapper   lighten-2" style={{backgroundColor: " #f0a62f", fontStyle: "italic", fontWeight: "bold"}}>
        {/* #3da56d */}
          <Link to={state?"/":"/signin"} className="brand-logo left " style = {{color: "#ffffff"}}>Social Opportunity Website</Link>
